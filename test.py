...
can you please make the comments in the script in english and also correct the following:
Le titre doit avoir un espace avec le contenu c'est à dire les graphiques et les textes qui scrollent
